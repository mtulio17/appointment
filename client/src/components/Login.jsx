...
const Login = () => {
  const { login, loading, user, loginWithGoogle, error: authError } = useAuth();
  ...
  return (
    ...
    <div className="max-w-md mx-auto mt-10 p-10 bg-[#ffffff] shadow-md rounded-lg">
      ...
      {error && <p className="text-red-500 text-sm text-center">{error}</p>} {/* Muestra errores si los hay */}
      ...
      <button
        ...
        className="flex justify-center items-center w-full max-w-80 mx-auto mt-4 border border-gray-300 bg-white text-gray-700 py-2 px-4 rounded-lg shadow-sm hover:bg-sky-100/50 focus:outline-sky-100 duration-300"
      >
        <img
      ...
      <p className="justify-center items-center text-center text-gray-700 text-pretty mt-4 text-xs">
        Si continúas, aceptas los{' '}
        <a href="#" className="font-medium hover:underline">
          Términos del servicio
        </a>{' '}
        de Appointment y confirmas que has leído nuestra{' '}
        <a href="#" className="font-medium hover:underline">
